                    ...
                    <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="card-body">
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<td><a class='btn btn-primary' href='reply_page.php?student_id=" . urlencode($row['student_id']) . "'>Reply Message</a></td>";
                                            echo "</tr>";
                                        }
                        ...
                        <div class="tab-pane fade" id="pills-reorder" role="tabpanel" aria-labelledby="pills-reorder-tab">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <?php
                                    $query = "SELECT * FROM medicines WHERE stock <= $reorder_threshold"; // Changed variable name
                                    $result = mysqli_query($connection, $query);
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<input type='text' class='form-control' id='medicine_name" . $row['id'] . "' name='edit_medicine_name' value='" . htmlspecialchars($row['medicine_name']) . "' required>";
                                            echo "</div>";
                                            echo "<div class='form-group'>";
                                            echo "<label for='stock" . $row['id'] . "'>Stock</label>";
                                            echo "<input type='number' class='form-control' id='stock" . $row['id'] . "' name='current_stock' value='" . htmlspecialchars($row['stock']) . "' required>";
                                            echo "</div>";
                                            echo "</div>";
                                            ...
                                            echo "<input type='text' class='form-control' id='manufacturer" . $row['id'] . "' name='manufacturer' value='" . htmlspecialchars($row['manufacturer']) . "' required>";
                                            echo "</div>";
                                            echo "<div class='form-group'>";
