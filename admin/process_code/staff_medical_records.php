...
$role = 2; // Assuming role is an integer
...
try {
    ...
    $stmt = $connection->prepare("INSERT INTO staff_clinic_record_table (staff_id, illness, symptoms, date_diagnosed, note, recommendation) VALUES (?, ?, ?, ?, ?, ?)");
