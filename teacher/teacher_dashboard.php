                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="medicalRecordTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                $query = "SELECT * FROM administrator_clinicrecord_table WHERE administrator_id = '$teacher_id' AND role = '$role' ";
                                                $result = mysqli_query($connection, $query);
                                                while ($record = mysqli_fetch_assoc($result)) {
                                                    $month_name = date("F-m-y", strtotime($record['date_diagnosed']));
                                                    echo "<tr>";
                                                    echo "<td>" . htmlspecialchars($record['record_id']) . "</td>";
                                                    echo "<td>" . htmlspecialchars($record['administrator_id']) . "</td>";
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <ul class="list-group">
                ...
                <li class="list-group-item">Bring your teacher ID and any necessary documents.</li>
