...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo "<td>";
    echo "<a class='btn btn-success' href='student_medical_records_page.php?student_id=" . $row['student_id'] . "'>View Medical Records</a> ";
    echo "</td>";
    echo "</tr>";
    ...
    $course_option = ['Computer Science','Information Technology','Engineering','Business teacheristration','Psychology','Nursing'];
    echo "<div class='form-group'>";
