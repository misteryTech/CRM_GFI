...
<a class="nav-link" href="staff_medical_records.php?user_id=<?php echo htmlspecialchars($staffId); ?>">
...
<a class="nav-link" href="message_page.php?user_id=<?php echo htmlspecialchars($staffId); ?>">
